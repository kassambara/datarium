...
Contains 23 curated data sets for teaching classical statistical inference in R. Each data set is paired with the analysis it is designed to teach — one data set per test. The same map is available in R via `?datarium`. Each analysis below links to its worked tutorial on [Datanovia](https://www.datanovia.com).
